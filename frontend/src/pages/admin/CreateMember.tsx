...
const CreateMember = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await client.post('/admin/members', {
                name: formData.name,
            ...
            setError(err.response?.data?.message_data || 'Failed to create member');
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 mt-1">Create a new member account (Leader)</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                            <div className="flex gap-3">
                                ...
                                <div className="text-sm text-indigo-700">
                                    <p className="font-medium mb-1">Member Account Information</p>
                                    <ul className="list-disc list-inside space-y-1 text-indigo-600">
                                        <li>Members act as leaders/coordinators for resellers</li>
